 ...
 * - Location: Default (~/.ws-workspace/workspaces/) or Custom
 */
export function AddWorkspaceStep_CreateNew({
  ...
  const defaultBasePath = homeDir ? `${homeDir}/.ws-workspace/workspaces` : '~/.ws-workspace/workspaces'
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle="under .ws-workspace folder"
          />
