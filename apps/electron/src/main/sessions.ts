...
import { type AgentEvent, setPermissionMode, hydratePreviousPermissionMode, getPermissionModeDiagnostics, type PermissionMode, unregisterSessionScopedToolCallbacks, mergeSessionScopedToolCallbacks, AbortReason, type AuthRequest, type AuthResult, type CredentialAuthRequest, type BrowserPaneFns } from '@ws-workspace/shared/agent'
import {
...
import { toolMetadataStore, getLastApiError } from '@ws-workspace/shared/interceptor'
...
import { AutomationSystem, AUTOMATIONS_HISTORY_FILE, type AutomationSystemMetadataSnapshot } from '@ws-workspace/shared/automations'
...
export class SessionManager {
   ...
   */
  private broadcastSkillsChanged(workspaceId: string, skills: import('@ws-workspace/shared/skills').LoadedSkill[]): void {
    if (!this.windowManager) return
