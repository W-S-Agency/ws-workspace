...
import { type AgentEvent, setPermissionMode, type PermissionMode, unregisterSessionScopedToolCallbacks, AbortReason, type AuthRequest, type AuthResult, type CredentialAuthRequest } from '@ws-workspace/shared/agent'
import {
...
import { resolveAuthEnvVars } from '@ws-workspace/shared/config'
import { toolMetadataStore } from '@ws-workspace/shared/interceptor'
import { getCredentialManager } from '@ws-workspace/shared/credentials'
import { CraftMcpClient, McpClientPool, McpPoolServer } from '@ws-workspace/shared/mcp'
import { type Session, type Message, type SessionEvent, type FileAttachment, type StoredAttachment, type SendMessageOptions, IPC_CHANNELS, generateMessageId } from '../shared/types'
import { formatPathsToRelative, formatToolInputPaths, perf, encodeIconToDataUrl, getEmojiIcon, resetSummarizationClient, resolveToolIcon, readFileAttachment } from '@ws-workspace/shared/utils'
...
import { getToolIconsDir, getMiniModel } from '@ws-workspace/shared/config'
        ...
        if (isAuthError && !managed.authRetryAttempted && managed.lastSentMessage) {
          ...
          setImmediate(async () => {
            try {
              ...
              getSentry().captureException(retryError, {
