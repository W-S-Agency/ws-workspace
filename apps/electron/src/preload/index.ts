...
const api: ElectronAPI = {
  ...
  createSource: (workspaceId: string, config: Partial<import('@ws-workspace/shared/sources').FolderSourceConfig>) =>
  ...
  onSourcesChanged: (callback: (workspaceId: string, sources: import('@ws-workspace/shared/sources').LoadedSource[]) => void) => {
    const handler = (_event: Electron.IpcRendererEvent, workspaceId: string, sources: import('@ws-workspace/shared/sources').LoadedSource[]) => {
  ...
  onSkillsChanged: (callback: (workspaceId: string, skills: import('@ws-workspace/shared/skills').LoadedSkill[]) => void) => {
    const handler = (_event: Electron.IpcRendererEvent, workspaceId: string, skills: import('@ws-workspace/shared/skills').LoadedSkill[]) => {
  ...
  onAppThemeChange: (callback: (theme: import('@ws-workspace/shared/config').ThemeOverrides | null) => void) => {
    const handler = (_event: Electron.IpcRendererEvent, theme: import('@ws-workspace/shared/config').ThemeOverrides | null) => {
      callback(theme)
    }
