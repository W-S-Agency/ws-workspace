 ...
 *
 * Validates Mermaid diagram syntax using @ws-workspace/mermaid parser.
 * No DOM required - works identically in Claude and Codex.
 */

import type { SessionToolContext } from '../context.ts';
import type { ToolResult } from '../types.ts';
import { parseMermaid } from '@ws-workspace/mermaid';
 ...
 *
 * Uses parseMermaid from @ws-workspace/mermaid to validate syntax.
    ...
    return {
      content: [{
        ...
        text: JSON.stringify({
          valid: false,
          error: errorMessage,
          suggestion: 'Check the syntax against ~/.ws-workspace/docs/mermaid.md',
        }, null, 2),
      }],
      isError: true,
    };
