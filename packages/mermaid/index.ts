/**
 * Generates index.html showcasing all @ws-workspace/mermaid rendering capabilities.
 *
    ...
    <div class="brand-badge-wrapper">
      ...
      <div class="brand-dropdown shadow-modal-small" id="brand-dropdown">
        <a href="https://agents.craft.do" class="brand-dropdown-item" target="_blank" rel="noopener">
          ...
          <span style="margin-left: -2px;">WS Workspace<span class="tagline">Simply mind-blowing</span></span>
        </a>
...
${bundleJs}
  ...
  <footer class="site-footer">
    <span>&copy; 2026 W&amp;S Agency All rights reserved.</span>
