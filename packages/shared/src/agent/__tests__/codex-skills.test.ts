 ...
 * - parseMentions() from @ws-workspace/shared/mentions (parses [skill:slug] syntax)
 * - stripAllMentions() from @ws-workspace/shared/mentions (removes all [bracket] mentions)
