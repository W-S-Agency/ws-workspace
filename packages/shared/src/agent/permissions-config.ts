 ...
 *
 * File locations:
 * - Workspace: ~/.ws-workspace/workspaces/{slug}/permissions.json
 * - Per-source: ~/.ws-workspace/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.ws-workspace/permissions/
 */
...
/**
 * Load default permissions from ~/.ws-workspace/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.ws-workspace/permissions/default.json)
   ...
   * These come from ~/.ws-workspace/permissions/default.json
   */
