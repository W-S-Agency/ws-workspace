 ...
 *
 * The mapping lives in ~/.ws-workspace/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.ws-workspace/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.ws-workspace/tool-icons/ containing tool-icons.json and icon files
