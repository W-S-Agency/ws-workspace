 ...
 * Default location: ~/.ws-workspace/workspaces/
 */
...
/**
 * Get the default workspaces directory (~/.ws-workspace/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.ws-workspace/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.ws-workspace/workspaces/
 */
