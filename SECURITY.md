...
We take security seriously. If you discover a security vulnerability in WS Workspace, please report it responsibly.
...
- The WS Workspace desktop application
- The `@craft-agent/*` npm packages
- Official WS Workspace repositories
